...
def add_cities_data(apps, schema_editor):
    ...
    cities = [
        ...
        {'taluka_name': 'Jotan', 'no_of_schools': 10, 'no_of_hospitals': 2, 'no_of_colleges': 0, 'no_of_universities': 0, 'no_of_railway_stations': 0, 'no_of_bus_stations': 1, 'no_of_post_offices': 1, 'no_of_police_stations': 0, 'no_of_fire_stations': 0, 'date': '2024-08-18', 'srno': 2},
